...
byte_array_t counters_enc_event_trigger_plain(counters_event_trigger_t const* event_trigger)
{
...
byte_array_t counters_enc_action_def_plain(counters_action_def_t const* action_def)
{
...
byte_array_t counters_enc_ind_hdr_plain(counters_ind_hdr_t const* ind_hdr)
{
  assert(ind_hdr != NULL);

  byte_array_t ba = {0};

  ba.len = sizeof(counters_ind_hdr_t);
...
byte_array_t counters_enc_ind_msg_plain(counters_ind_msg_t const* ind_msg)
{
  assert(ind_msg != NULL);
  ...
  size_t const sz = sizeof(ind_msg->len) + 
                  sizeof(counters_stats_t)*ind_msg->len + 
...
byte_array_t counters_enc_call_proc_id_plain(counters_call_proc_id_t const* call_proc_id)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t counters_enc_ctrl_hdr_plain(counters_ctrl_hdr_t const* ctrl_hdr)
{
  assert(ctrl_hdr != NULL);
  byte_array_t  ba = {0};
  ba.len = sizeof(counters_ctrl_hdr_t);
  ba.buf = calloc(ba.len, sizeof(uint8_t)); 
  assert(ba.buf != NULL && "Memory exhausted");
...
byte_array_t counters_enc_ctrl_msg_plain(counters_ctrl_msg_t const* ctrl_msg)
{
...
byte_array_t counters_enc_ctrl_out_plain(counters_ctrl_out_t const* ctrl) 
{
  assert(0!=0 && "Not implemented");
...
byte_array_t counters_enc_func_def_plain(counters_func_def_t const* func)
{
  assert(0!=0 && "Not implemented");

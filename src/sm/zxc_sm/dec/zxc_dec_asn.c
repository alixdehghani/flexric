...
zxc_event_trigger_t zxc_dec_event_trigger_asn(size_t len, uint8_t const buf[len])
{
  assert(0!=0 && "Not implemented");
  assert(buf != NULL);
  zxc_event_trigger_t avoid_warning;
...
zxc_action_def_t zxc_dec_action_def_asn(size_t len, uint8_t const action_def[len])
{
  ...
  zxc_action_def_t avoid_warning;
  return avoid_warning;
}
...
zxc_call_proc_id_t zxc_dec_call_proc_id_asn(size_t len, uint8_t const call_proc_id[len])
{
  ...
  zxc_call_proc_id_t avoid_warning;
  return avoid_warning;
}

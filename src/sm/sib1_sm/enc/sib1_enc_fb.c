...
//#include "../ie/fb/e2sm_sib1_stats_v00_builder.h"
//#include "../ie/fb/e2sm_sib1_stats_v00_verifier.h"
...
byte_array_t sib1_enc_action_def_fb(sib1_action_def_t const* action_def)
{
...
byte_array_t sib1_enc_ind_hdr_fb(sib1_ind_hdr_t const* ind_hdr)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t sib1_enc_ind_msg_fb(sib1_ind_msg_t const* ind_msg)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t sib1_enc_call_proc_id_fb(sib1_call_proc_id_t const* call_proc_id)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t sib1_enc_ctrl_hdr_fb(sib1_ctrl_hdr_t const* ctrl_hdr)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t sib1_enc_ctrl_msg_fb(sib1_ctrl_msg_t const* ctrl_msg)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t sib1_enc_ctrl_out_fb(sib1_ctrl_out_t const* ctrl) 
{
  assert(0!=0 && "Not implemented");
...
byte_array_t sib1_enc_func_def_fb(sib1_func_def_t const* func)
{
  assert(0!=0 && "Not implemented");

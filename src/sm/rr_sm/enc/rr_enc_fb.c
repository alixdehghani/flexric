...
//#include "../ie/fb/e2sm_rr_stats_v00_builder.h"
//#include "../ie/fb/e2sm_rr_stats_v00_verifier.h"


/*
byte_array_t rr_enc_event_trigger_fb(rr_event_trigger_t const* event_trigger)
{
...
byte_array_t rr_enc_action_def_fb(rr_action_def_t const* action_def)
{
...
byte_array_t rr_enc_ind_hdr_fb(rr_ind_hdr_t const* ind_hdr)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t rr_enc_ind_msg_fb(rr_ind_msg_t const* ind_msg)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t rr_enc_call_proc_id_fb(rr_call_proc_id_t const* call_proc_id)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t rr_enc_ctrl_hdr_fb(rr_ctrl_hdr_t const* ctrl_hdr)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t rr_enc_ctrl_msg_fb(rr_ctrl_msg_t const* ctrl_msg)
{
  assert(0!=0 && "Not implemented");
...
byte_array_t rr_enc_ctrl_out_fb(rr_ctrl_out_t const* ctrl) 
{
  assert(0!=0 && "Not implemented");
...
byte_array_t rr_enc_func_def_fb(rr_func_def_t const* func)
{
  assert(0!=0 && "Not implemented");
